...
SITES = [
    {"search_name": "Addo Spar Smart Logger",           "slug": "addo-spar",              "station_code": ""},
    {"search_name": "Bel Essex(Valeo)",                  "slug": "bel-essex-valeo",        "station_code": ""},
    {"search_name": "BIMBO NRG",                         "slug": "bimbo-nrg",              "station_code": ""},
    {"search_name": "BMI park",                          "slug": "bmi-park",               "station_code": ""},
    {"search_name": "BMI Paterson",                      "slug": "bmi-paterson",           "station_code": ""},
    {"search_name": "Coega Dairy",                       "slug": "coega-dairy",            "station_code": ""},
    {"search_name": "GM-Hasty Tasty",                    "slug": "gm-hasty-tasty",         "station_code": ""},
    {"search_name": "Keypak Part 2",                     "slug": "keypak-part-2",          "station_code": ""},
    {"search_name": "Kirkwood FNB",                      "slug": "kirkwood-fnb",           "station_code": ""},
    {"search_name": "kirkwood spar power meter",         "slug": "kirkwood-spar",          "station_code": ""},
    {"search_name": "MP The Pines",                      "slug": "mp-the-pines",           "station_code": ""},
    {"search_name": "Mountain View shopping centre",     "slug": "mountain-view-sc",       "station_code": ""},
    {"search_name": "Nautica Shopping Centre",           "slug": "nautica-sc",             "station_code": ""},
    {"search_name": "RDM Somerset West 5MW",             "slug": "rdm-somerset-west",      "station_code": ""},
    {"search_name": "Shoprite Parklands",                "slug": "shoprite-parklands",      "station_code": ""},
    {"search_name": "WG Group - Mdantsane SuperSpar",    "slug": "wg-mdantsane-superspar", "station_code": ""},
    {"search_name": "WG Group - Nurture Health",         "slug": "wg-nurture-health",      "station_code": ""},
]
    ...
    try:
        ...
        for code, site in code_to_site.items():
            ...
            for entry in hr:
                ...
                # collectTime is epoch ms — convert to SAST hour
                if ct:
                    hour = datetime.fromtimestamp(ct / 1000, tz=SAST).hour
                    pv_yield = dim.get("radiation_intensity", 0) or 0
                    # radiation_intensity is actually the PV yield per hour
                    # The actual field name varies — try multiple
                    inv_power = dim.get("inverter_power", 0) or 0
                    ongrid_power = dim.get("ongrid_power", 0) or 0
                    pv = dim.get("power_profit", 0) or 0
                    # Use whichever field has data
                    hourly_pv[hour] = round(pv or ongrid_power or inv_power, 2)

            total_kwh = rt.get("day_power", 0) or sum(hourly_pv)
